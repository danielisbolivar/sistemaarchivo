...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h3 align="center">Consulta General - Estudiantes </h3>
                  <div style="float:right">
                    <a id="add_row" class="btn btn-inverse-primary" href="pdf/pdf.php?id=<?php echo $id ?>&seccion=<?php echo $seccion ?>&id_materia=<?php echo $id_materia ?>" target="nuevo">Generar <i class="mdi mdi-file-pdf-box"></i>
