...
<?php 
$buscar = $_GET['buscar'];
$sql = "SELECT * FROM estudiantes WHERE sede = '$buscar'";
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <H4 align="center">Lista General de Estudiantes de la Sede: <font color="red"><?php echo $buscar; ?></font> </H4><hr>
                  <div style="float:right">
                    <a id="add_row" class="btn btn-inverse-primary" href="pdf/pdf7.php?sede=<?php echo $buscar; ?>" target="nuevo">Generar <i class="mdi mdi-file-pdf-box"></i>
                      ...
                      $sql = ("SELECT   * FROM estudiantes 
                      	       INNER JOIN telefono ON estudiantes.id_estudiante = telefono.id_estudiante
								               INNER JOIN email  ON estudiantes.id_estudiante = 
								                  email.id_estudiante
								               INNER JOIN direccion  ON estudiantes.id_estudiante = direccion.id_estudiante 
                               WHERE estudiantes.sede = '$buscar' 
								               Order by estudiantes.id_estudiante DESC");
