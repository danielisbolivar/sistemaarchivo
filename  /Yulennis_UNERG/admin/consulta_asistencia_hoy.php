...
$fecha = date('Y/m/d');
$sql = "SELECT * FROM asistencia WHERE fecha = '$fecha' AND id_profesor > '0'";
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 align="center">Consulta de Asistencia del Dia - Profesores</h3><hr>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                          	<a href="editar_asistencia.php?id_asistencia=<?php echo $reg['id_asistencia']?>">
           ...
           <ul class="pagination">             
			...
			<?php echo $_GET['pagina']<$paginas? 'disabled':'' ?>">
				<a class="page-link" href="consulta_asistencia_hoy.php?pagina=<?php echo $_GET['pagina']-1 ?>">< Anterior</a></li>  

			<?php for ($i=0;$i< $paginas;$i++): ?>

			 <li class="page-item 
			 <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
				 <a class="page-link" href="consulta_asistencia_hoy.php?pagina=<?php echo $i+1; ?>">
				 	<?php echo $i+1; ?>
				 </a>
			 </li>
			...
			<li class="page-item
			<?php echo $_GET['pagina']>=$paginas? 'disabled':'' ?>"><a class="page-link" href="consulta_asistencia_hoy.php?pagina=<?php echo $_GET['pagina']+1 ?>">Siguiente ></a></li>
		  </ul>
