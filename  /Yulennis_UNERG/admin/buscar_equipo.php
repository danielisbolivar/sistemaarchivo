...
$sql = "SELECT * FROM productos WHERE sede ='$sede' AND estado = '$estado' AND id_categoria = '$id_categoria'";
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  ?>
                   <?php while ($reg1 = $result1->fetch_array()){
                                      $num++;
                       ?>
                      
                      <?php echo $reg1['categoria'];?>
                  ...
                  <div style="float:right">
                    <a id="add_row" class="btn btn-inverse-primary" href="pdf/pdf1.php?sede=<?php echo $sede ?>&estado=<?php echo $estado ?>&id_categoria=<?php echo $id_categoria ?>" target="nuevo">Generar <i class="mdi mdi-file-pdf-box"></i>
