...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModalmateria"><i class="mdi mdi-plus"></i> Agregar Nueva</button> 
                 <h3 align="center">Lista de Materias Registradas </h3><hr>
                  ...
                  <?php 
                      ...
                      $sql = ("SELECT   * FROM materia  Order by id_materia DESC LIMIT $reg1, $mostrar");
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="editar_materia.php?id_materia=<?php echo $reg['id_materia']?>">
                          <button title="Editar" class="btn btn-inverse-primary btn-sm">
                            <i class="mdi mdi-table-edit"></i> </button></a>


                            <a href="eliminar/eliminar_materia.php?id_materia=<?php echo $reg['id_materia']?>" onclick=" return ConfirmDelete()">
      ...
      <?php echo $_GET['pagina']<$paginas? 'disabled':'' ?>">
        <a class="page-link" href="consulta_materia.php?pagina=<?php echo $_GET['pagina']-1 ?>">< Anterior</a></li>  

      <?php for ($i=0;$i< $paginas;$i++): ?>

       <li class="page-item 
       <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
         <a class="page-link" href="consulta_materia.php?pagina=<?php echo $i+1; ?>">
          <?php echo $i+1; ?>
         </a>
       </li>
      ...
      <li class="page-item
      <?php echo $_GET['pagina']>=$paginas? 'disabled':'' ?>"><a class="page-link" href="consulta_materia.php?pagina=<?php echo $_GET['pagina']+1 ?>">Siguiente ></a></li>
      </ul>
