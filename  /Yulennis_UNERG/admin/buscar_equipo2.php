              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div style="float:right">
                    <a id="add_row" class="btn btn-inverse-primary" href="pdf/pdf3.php?sede=<?php echo $sede ?>" target="nuevo">Generar <i class="mdi mdi-file-pdf-box"></i>
                  ...
                  <?php 
                      ...
                      $sql = ("SELECT  * FROM productos 
                                  ...
                                  WHERE productos.id_categoria = categorias.id_categoria AND productos.sede = '$sede' AND productos.id_categoria = categorias.id_categoria
