...
if ($num == 0) {
  ...
  $sql = ("INSERT into prof_materias(id_profesor,id_responsable,id_materia,seccion,dia,hora1,hora2,aula_lab) values
   ('0','$id_responsable','0','0','$dia','$hora1','$hora2','$aula_lab')");

  // muestro mensajes 
  if (mysqli_query($mysqli, $sql)) {
    
            echo "<meta http-equiv='refresh' content='0;url=../asignar_horario.php?msj=exito'>";

      }

}else{

  echo "<meta http-equiv='refresh' content='0;url=../asignar_horario.php?msj=ocupado'>";
