...
if ($ultimo_id > 0) {
  ...
  if (mysqli_query($mysqli, $sql3)) {
            ...
            echo "<meta http-equiv='refresh' content='0;url=../../index.php?msj=exito' data-toggle='modal' href='#myModal'>";

      }else {
             echo "<meta http-equiv='refresh' content='0;url=../../index.php?msj=error' data-toggle='modal' href='#myModal'>";
           }
      }
     }
    }
