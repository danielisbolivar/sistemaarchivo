...
<?php 
$buscar = $_GET['buscar'];
$sql = "SELECT * FROM profesores WHERE sede ='$buscar'";
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  <h4 align="center">Consulta por Sede de Profesores: <font color="red"><?php echo $buscar; ?></font> </h4>
                  <hr>
                  <div style="float:right">
                    <a id="add_row" class="btn btn-inverse-primary" href="pdf/pdf5.php?sede=<?php echo $buscar ?>" target="nuevo">Generar <i class="mdi mdi-file-pdf-box"></i>
                          	...
                          	<div class="btn-group-vertical">
                                <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu">
                                    ...
                                    <!--<a class="dropdown-item" href="eliminar/activar_prof.php?id_profesor=<?php //echo $reg['id_profesor']?>" onclick=" return ConfirmActivar()">Activar</a>


                                    <a class="dropdown-item" href="eliminar/desabilitar_prof.php?id_profesor=<?php //echo $reg['id_profesor']?>" onclick=" return ConfirmDesabilitar()">Desactivar</a>-->
           ...
           <ul class="pagination">             
			...
			<?php echo $_GET['pagina']<$paginas? 'disabled':'' ?>">
				<a class="page-link" href="buscar_profesor.php?pagina=<?php echo $_GET['pagina']-1 ?>">< Anterior</a></li>  

			<?php for ($i=0;$i< $paginas;$i++): ?>

			 <li class="page-item 
			 <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
				 <a class="page-link" href="buscar_profesor.php?pagina=<?php echo $i+1; ?>">
				 	<?php echo $i+1; ?>
				 </a>
			 </li>
			...
			<li class="page-item
			<?php echo $_GET['pagina']>=$paginas? 'disabled':'' ?>"><a class="page-link" href="buscar_profesor.php?pagina=<?php echo $_GET['pagina']+1 ?>">Siguiente ></a></li>
		  </ul>
