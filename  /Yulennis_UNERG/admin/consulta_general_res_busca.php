...
<?php 
$buscar = $_GET['buscar'];
$sql = "SELECT * FROM responsables WHERE sede = '$buscar'";
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 align="center">Consulta General de Responsables de los Laboratorios por Sede: <font color="red"><?php echo $buscar; ?></font> </h4><hr>
                  <div style="float:right">
                    <a id="add_row" class="btn btn-inverse-primary" href="pdf/pdf9.php?sede=<?php echo $buscar; ?>" target="nuevo">Generar <i class="mdi mdi-file-pdf-box"></i>
                  ...
                  <?php 
                      ...
                      $sql = ("SELECT   * FROM responsables 
								  ...
								  direccion.id_responsable WHERE responsables.sede = '$buscar'
