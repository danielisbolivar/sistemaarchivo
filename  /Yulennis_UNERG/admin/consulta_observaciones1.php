...
$sql = "SELECT * FROM observaciones WHERE id_responsable > '0'";
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                 ...
                 <h4 align="center">Observaciones Registradas de los Responsables de Laboratorio </h4><hr>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="editar_observaciones1.php?id_observaciones=<?php echo $reg['id_observaciones']?>">
                          <button title="Editar" class="btn btn-inverse-primary btn-sm">
                            <i class="mdi mdi-table-edit"></i> </button></a>


                            <a href="eliminar/eliminar_observaciones1.php?id_observaciones=<?php echo $reg['id_observaciones']?>" onclick=" return ConfirmDelete()">
